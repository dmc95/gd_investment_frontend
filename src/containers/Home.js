...
const Home = ({ showSuccessToast }) => {
  ...
  return (
    ...
    <section className="w-[310px] sm:w-full 2xl:w-5/6 xl:w-5/6 h-[3200px] 2xl:h-[2500px]  mx-auto z-0">
      ...
      <div className="w-full">
        <CarouselEtf
          divParent={"2xl:w-11/12 lg:h-[400] h-[600px] flex items-end overflow-x-hidden"}
          divText={"w-[300px]"}
          divCard={
            " mx-2 sm:w-1/2 sm:h-1/4 w-3/12 md:h-1/3 2xl:my-8 my-3 p-2 text-lg border rounded-lg shadow-md backdrop-blur-sm bg-white/30 animate-scroll"
          }
